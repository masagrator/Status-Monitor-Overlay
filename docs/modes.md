...
Contains most of supported informations with lower precision. You can use touch screen or motion controls to change its position temporarily.
...
Mode available only with SaltyNX installed. You can use touch screen or motion controls to change its position temporarily.
...
For this mode to show and work properly you must have SaltyNX 0.9.0+ installed. You can use touch screen or motion controls to change its position temporarily.
