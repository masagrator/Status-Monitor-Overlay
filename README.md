...
- GPU Load
- CPU, GPU & RAM target frequencies (also real frequencies + RAM Load if [sys-clk 2.0.0+](https://github.com/retronx-team/sys-clk/releases) is installed, use only official retronx release or its open source forks for reliable results)
